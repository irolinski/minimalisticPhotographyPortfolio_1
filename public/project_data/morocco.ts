...
const url = '/#/projekty/' + `${name.split(' ')[0]}`;

const imgUrl = "https://res.cloudinary.com/dtjtqp7r1/image/upload/v1712437337/z-Ola%20K.-Portfolio/MAROCO/kpaf2w5qjnwr9hwmwhkx.jpg"
