...
export const slides = [
    ...
    "https://res.cloudinary.com/dtjtqp7r1/image/upload/v1712437333/z-Ola%20K.-Portfolio/PHOTO%202/u3lpovrveljkguqqz7fa.jpg",
    ...
    "https://res.cloudinary.com/dtjtqp7r1/image/upload/v1712437327/z-Ola%20K.-Portfolio/PHOTO%202/sy0bxy5xmejxpod71zra.jpg",
    "https://res.cloudinary.com/dtjtqp7r1/image/upload/v1712437332/z-Ola%20K.-Portfolio/PHOTO%202/xpmexoul6aer7oxye6wk.jpg"
]; 

const url = '/#/projekty/' + `${name.replace(' ', '_')}`;

const imgUrl = "https://res.cloudinary.com/dtjtqp7r1/image/upload/v1712437332/z-Ola%20K.-Portfolio/PHOTO%202/a0cgpm9mzdbcp3mwrdwe.jpg";
